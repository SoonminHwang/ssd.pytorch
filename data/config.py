...
voc_ssd_anchor_free = {
    ...
    '320': {
        ...
        'min_sizes': [30, 60, 111, 162, 213, 264],
        'max_sizes': [60, 111, 162, 213, 264, 315],
        # 'min_sizes': [30,     60*0.5, 111*0.5, 162*0.5, 213*0.5, 264*0.5],
        # 'max_sizes': [60,        111,     162,     213,     264,     315],
        # 'min_sizes': [ 30,  60,  90, 120, 120, 264*0.5],
        # 'max_sizes': [ 90, 120, 150, 150,     264,     315],
        'aspect_ratios': [[2], [2, 3], [2, 3], [2, 3], [2], [2]],
        'variance': [0.1, 0.2],
        'clip': True,
        'name': 'voc_ssd320',
...
voc_stairnet300_38x38 = {
    'num_classes': 21,
    'lr_steps': (80000, 100000, 120000),
    'max_iter': 120000,
    # 'feature_maps': [38, 19, 10, 5, 3, 1],
    'feature_maps': [38, 38, 38, 38, 38],
    'min_dim': 300,
    'steps': [8, 8, 8, 8, 8],
    ...
    'variance': [0.1, 0.2],
    'clip': True,
    'name': 'voc_stairnet300_single_38x38',
    'inter_planes': 256
}
...
voc_refinedet = {
    '300': {
        ...
        # 'min_sizes': [32, 64, 128, 256],
        'min_sizes': [30, 61, 128, 256],
        'max_sizes': [],
        'aspect_ratios': [[2], [2], [2], [2]],
        'variance': [0.1, 0.2],
        'clip': True,
        'name': 'RefineDet_VOC_300',
    },
    '320': {
        'num_classes': 21,
        'lr_steps': (80000, 100000, 120000),
